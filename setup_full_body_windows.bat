...
python -m pip install diffusers==0.27.0 transformers==4.32.1 huggingface_hub==0.25.2 numpy==1.26.4 matplotlib opencv-python==4.8.1.78 accelerate==0.21.0 decord einops omegaconf onnxruntime-gpu
